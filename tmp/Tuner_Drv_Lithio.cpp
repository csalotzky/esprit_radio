...
int devTEF668x_Set_Cmd(TEF668x_MODULE module, uint8_t cmd, int len,...)
{
	int i;
...
//fill buffer with 16bits one by one
	...
	return TunerBufferWrite(buf, len);
}
...
static int devTEF668x_Get_Cmd(TEF668x_MODULE module, uint8_t cmd, uint8_t *receive,int len)
{
	...
	TunerBufferWrite(buf, 3);

	return TunerBufferRead(receive,len);
}
...
*/
int devTEF668x_Radio_Tune_To (bool fm,uint16_t mode,uint16_t frequency )
{
...
4 afu_sample_time
	...
	2000 = 2 ms (default)
*/
int devTEF668x_Radio_Set_Tune_Options(bool fm,uint16_t afu_bw_mode,uint16_t afu_bandwidth,uint16_t afu_mute_time,uint16_t afu_sample_time)
{
...
4 low_level_sensitivity
	...
	1000 = 100 % (default)
*/
int devTEF668x_Radio_Set_Bandwidth(bool fm,uint16_t mode,uint16_t bandwidth,uint16_t control_sensitivity,uint16_t low_level_sensitivity)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
2 extension
	...
	AM reserved
*/
int devTEF668x_Radio_Set_RFAGC(bool fm,uint16_t start,uint16_t extension)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Antenna(bool fm,uint16_t attenuation)
{
...
1 mode
	...
	1 = on
*/
int devTEF668x_Radio_Set_MphSuppression(bool fm,uint16_t mode)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
1 = on
*/
int devTEF668x_Radio_Set_ChannelEqualizer(bool fm,uint16_t mode)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_StereoImprovement(bool fm,uint16_t mode)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_StHiBlend_Time(bool fm,uint16_t slow_attack,uint16_t slow_decay,uint16_t fast_attack,uint16_t fast_decay)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
2 sensitivity
	...
	1000 = 100 % (default)
*/
int devTEF668x_Radio_Set_NoiseBlanker(bool fm,uint16_t mode,uint16_t sensitivity)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
2 sensitivity
	...
	1000 = 100 % (default)
*/
int devTEF668x_Radio_Set_NoiseBlanker_Audio(bool fm,uint16_t mode,uint16_t sensitivity)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_AM,
...
1 mode
	...
	1 = on
*/
int devTEF668x_Radio_Set_DigitalRadio(bool fm,uint16_t mode)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
1 timeconstant
	...
	750 = 75 ��s deemphasis
*/
int devTEF668x_Radio_Set_Deemphasis(bool fm,uint16_t timeconstant)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Softmute_Time(bool fm,uint16_t slow_attack,uint16_t slow_decay,uint16_t fast_attack,uint16_t fast_decay)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Softmute_Level(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
3 slope
	...
	1000 = 100% (default)
*/
int devTEF668x_Radio_Set_Softmute_Noise(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
3 slope
	...
	1000 = 100% (default)
*/
int devTEF668x_Radio_Set_Softmute_Mph(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Softmute_Max(bool fm,uint16_t mode,uint16_t limit)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Highcut_Time(bool fm,uint16_t slow_attack,uint16_t slow_decay,uint16_t fast_attack,uint16_t fast_decay)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Highcut_Mod(bool fm,uint16_t mode,uint16_t start,uint16_t slope,uint16_t shift)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Highcut_Level(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Highcut_Noise(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Highcut_Mph(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Highcut_Max(bool fm,uint16_t mode,uint16_t limit)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Highcut_Min(bool fm,uint16_t mode,uint16_t limit)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Lowcut_Min(bool fm,uint16_t mode,uint16_t limit)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Stereo_Time(bool fm,uint16_t slow_attack,uint16_t slow_decay,uint16_t fast_attack,uint16_t fast_decay)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Stereo_Mod(bool fm,uint16_t mode,uint16_t start,uint16_t slope,uint16_t shift)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Stereo_Level(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Stereo_Noise(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Stereo_Mph(bool fm,uint16_t mode,uint16_t start,uint16_t slope)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Stereo_Max(bool fm,uint16_t mode)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
*/
int devTEF668x_Radio_Set_Stereo_Min(bool fm,uint16_t mode,uint16_t limit)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
...
1 gain
	...
	0 = 0 dB (default)
*/
int devTEF668x_Radio_Set_Scaler(bool fm,uint16_t gain)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_RDS(bool fm,uint16_t mode,uint16_t restart,uint16_t interfac)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_FM,
			TEF665X_Cmd_Set_RDS,
			9,
...
*/
int devTEF668x_Radio_Set_QualityStatus(bool fm,uint16_t mode,uint16_t interfac)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
4 gain
	...
	0 = 0 dB (default)
*/
int devTEF668x_Radio_Set_DR_Blend(bool fm,uint16_t mode,uint16_t in_time,uint16_t out_time,uint16_t gain)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_DR_Options(bool fm,uint16_t samplerate)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Radio_Set_Specials(bool fm,uint16_t ana_out)
{
	return devTEF668x_Set_Cmd(fm ? TEF665X_MODULE_FM: TEF665X_MODULE_AM,
...
*/
int devTEF668x_Audio_Set_Mute(uint16_t mode)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_AUDIO,
...
2 source
	...
	240 = sine wave generator
*/
int devTEF668x_Audio_Set_Output_Source(uint16_t signal,uint16_t source)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_AUDIO,
...
(5) samplerate
	...
	4800 = 48.0 kHz
*/
int devTEF668x_Audio_Set_Dig_IO(uint16_t signal,uint16_t mode,uint16_t format,uint16_t operation,uint16_t samplerate)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_AUDIO,
...
1 mode
	...
	(default)
*/
int devTEF668x_APPL_Set_OperationMode(uint16_t mode)
{
...
*/
int devTEF668x_APPL_Set_ReferenceClock(uint16_t frequency_high,uint16_t frequency_low,uint16_t type)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_APPL,
...
*/
int devTEF668x_APPL_Activate(uint16_t mode)
{
	return devTEF668x_Set_Cmd(TEF665X_MODULE_APPL,
...
*/
int devTEF668x_Radio_Get_Quality_Status (bool fm,uint8_t *status)
{
	uint8_t buf[2];
	int r;
...
int devTEF668x_Radio_Get_Quality_Level (bool fm,uint8_t *status,int16_t *level)
{
	uint8_t buf[4];
	int r;
...
*/
int devTEF668x_Radio_Get_Quality_Data (bool fm,uint8_t *usn,uint8_t *wam,int16_t *offset)
{
	uint8_t buf[14];
	int r;
	int16_t temp;
...
int devTEF668x_Radio_Get_Quality_Data_Custom (bool fm,int8_t *level,uint8_t *bandwidth,uint8_t *modulation)
{
	uint8_t buf[14];
	int r;
	int16_t temp;
...
6 dec_error error code (determined by decoder)
	...
	[7:0] = reserved
*/
int devTEF668x_Radio_Get_RDS_Status(bool fm,uint16_t *status)
{
	uint8_t buf[2];
	int r;
...
int devTEF668x_Radio_Get_RDS_Data (bool fm,uint16_t *status,uint16_t *A_block,uint16_t *B_block,uint16_t *C_block,uint16_t *D_block,
	uint16_t *dec_error)
{
	uint8_t buf[12];
	int r;
...
int devTEF668x_Radio_Get_RDS_DataRaw (bool fm,uint16_t *status,uint32_t *raw_data)
{
	uint8_t buf[6];
	int r;
...
*/
int devTEF668x_Radio_Get_AGC(bool fm,uint16_t *input_att,uint16_t *feedback_att)
{
	uint8_t buf[4];
	int r;
...
*/
int devTEF668x_Radio_Get_Signal_Status(bool fm,uint16_t *status)
{
	uint8_t buf[2];
	int r;
...
*/
int devTEF668x_Radio_Get_Processing_Status(bool fm,uint16_t *softmute,uint16_t *highcut,uint16_t *stereo)
{
	uint8_t buf[6];
	int r;
...
1 samplerate
	...
	6750 = 675 kHz
*/
int devTEF668x_Radio_Get_Interface_Status(bool fm,uint16_t *samplerate)
{
	uint8_t buf[2];
	int r;
...
1 status
	...
	4 = active state; AM
*/
int devTEF668x_APPL_Get_Operation_Status(uint8_t *status)
{
	uint8_t buf[2];
	int r;
